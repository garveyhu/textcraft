from textcraft.core.config import dialog_model, keys_openai, model_temperature
...
class LLMCreator:
    ...
    def create_llm(cls, llm_type=None):
        ...
        if llm_class == OpenAI:
            ...
            return OpenAI(
                model=llm_type.lower(), temperature=temperature, api_key=openai_key
            )
